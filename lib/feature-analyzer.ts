...
export class FeatureAnalyzer {
  private craterModels: Record<string, any>
  private volcanicModels: any
  ...
  constructor() {
    ...
    this.craterModels = {
      'MARS': {
        ...
        getAge: (diameter: number, craterDensity: number) => {
    ...
    this.volcanicModels = {
      estimateAge: (planet: string, diameter: number, morphology: string) => {
  ...
  analyzeFeature(feature: Feature, planet: string, imageData?: any): AnalyzedEvent[] {
  ...
  private analyzeCrater(props: FeatureProperties, planet: string, imageData?: any): AnalyzedEvent[] {
  ...
  // Volcano analysis
  private analyzeVolcano(props: FeatureProperties, planet: string, imageData?: any): AnalyzedEvent[] {
  ...
  private analyzeChannel(props: FeatureProperties, planet: string, imageData?: any): AnalyzedEvent[] {
    const events: AnalyzedEvent[] = []
  ...
  // Lunar mare analysis
  private analyzeMare(props: FeatureProperties, planet: string, imageData?: any): AnalyzedEvent[] {
    const events: AnalyzedEvent[] = []
  ...
  // Plains analysis
  private analyzePlain(props: FeatureProperties, planet: string, imageData?: any): AnalyzedEvent[] {
    const events: AnalyzedEvent[] = []
  ...
  private estimateCraterAge(planet: string, diameter: number): number {
    if (planet === 'MARS') {
  ...
  private classifyFromName(name: string): string {
  ...
  private generateGenericTimeline(props: FeatureProperties, planet: string): AnalyzedEvent[] {
    return [{
      phase: 'Formation',
      years: 3500000000,
